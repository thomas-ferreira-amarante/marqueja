...
<div class="container py-5">
	<div class="row">
		<div class="col-md-12">
			<h3> Dados e informações da quadra:</h3>
		</div>
	</div>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			<h5> Valor - Manhã: </h5> <input type="text" class="form-control" name="valor_manha" value="" placeholder="" ></input> <button type="submit" class="btn btn-warning py-2"> Alterar valor </button>
				
		</div>
		<div class="col-md-4">
			<h5> Valor - Tarde: </h5>  <input type="text" class="form-control" name="valor_tarde" value="" placeholder="" ></input> <button type="submit" class="btn btn-warning py-2"> Alterar valor </button>
		</div>
		<div class="col-md-4">
			<h5> Valor - Noite:</h5>  <input type="text" class="form-control" name="valor_noite" value="" placeholder="" ></input> <button type="submit" class="btn btn-warning py-2"> Alterar valor </button>
		</div>
	</div>
</div>																												

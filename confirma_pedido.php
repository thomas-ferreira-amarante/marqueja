    ...
    <div class="container py-5 bg-primary">
      <div class="row">
		...
		<div class="col-md-3">
				...
				<input type="hidden" name="hora" value="<?php echo $hora?>" placeholder=" <?php echo $hora?>"></button>
				<input type="hidden" name="valor" value="<?php echo $valor?>" placeholder=" <?php echo $valor?>"></button>						
        </div>
		</form>
      </div>
    </div>
